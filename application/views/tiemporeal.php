...
<html>
 <head>
 	<title>Sistema de Monitoreo de heladera</title>
...
<div class="col-md-2"><p><input type='text' class="form-control" id="hum2" name="hum2" readonly value=<?php echo "'".$datos["temp2"]." °C'"; ?>></input></p></div>
</div>
